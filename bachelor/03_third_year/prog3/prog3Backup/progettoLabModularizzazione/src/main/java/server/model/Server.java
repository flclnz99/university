   ...
   public Server() {
    ...
    public void startListening() throws IOException {
        ...
        while(true){
            ...
            Integer index = null;
            Email email = null;
            GetMailsTask getMailsTask = null;
            HandleMailTask handleMailTask = null;
            ...
            if(type.equalsIgnoreCase("getMails")){
                getMailsTask = new GetMailsTask(client, inStream, outStream, clientName, index);
            ...
            if(type.equalsIgnoreCase("sendMail")){
                handleMailTask = new HandleMailTask(client, inStream, outStream, clientName, email);
                //getMailsTasks.add(getMailsTask);
